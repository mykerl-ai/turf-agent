<template>
  <main>
    ...
    >
      <div
        v-if="lite"
        class="absolute right-0 top-0 mt-3 mx-3 cursor-pointer"
        @click="close"
      >
      ...
      >
        <div v-if="!lite" class="float-right mt-3 mx-3">
          <svg
        ...
        <hr
          v-if="isBorder && isHeader"
          class="mt-2 mb-4 border border-dividerColor text-dividerColor"
        />
